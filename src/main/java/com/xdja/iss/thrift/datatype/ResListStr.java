...
public class ResListStr implements org.apache.thrift.TBase<ResListStr, ResListStr._Fields>, java.io.Serializable, Cloneable, Comparable<ResListStr> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ResListStrStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ResListStrTupleSchemeFactory();

  public int res; // required
  public java.util.List<String> value; // required
  ...
  public ResListStr(ResListStr other) {
    ...
    this.res = other.res;
    if (other.isSetValue()) {
      java.util.List<String> __this__value = new java.util.ArrayList<String>(other.value);
  ...
  public void addToValue(String elem) {
    if (this.value == null) {
      this.value = new java.util.ArrayList<String>();
    }
    this.value.add(elem);
  }
  ...
  public ResListStr setValue(java.util.List<String> value) {
    this.value = value;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VALUE:
      if (value == null) {
        ...
        setValue((java.util.List<String>)value);
      }
      break;
  ...
  private static class ResListStrStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ResListStrStandardScheme getScheme() {
      return new ResListStrStandardScheme();
    }
  }

  private static class ResListStrStandardScheme extends org.apache.thrift.scheme.StandardScheme<ResListStr> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<String>(_list0.size);
                String _elem1;
  ...
  private static class ResListStrTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ResListStrTupleScheme getScheme() {
      return new ResListStrTupleScheme();
    }
  }

  private static class ResListStrTupleScheme extends org.apache.thrift.scheme.TupleScheme<ResListStr> {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.value = new java.util.ArrayList<String>(_list5.size);
          String _elem6;
